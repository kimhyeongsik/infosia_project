...
function calendar_draw(set_date)
{
    ...
    html += "<span style=\"font-size:12px; font-family:Dotum; color:#303030; cursor:pointer;\" bgcolor=\"#f3f3f3\">"+calendar_y+"년</span>";
    html += "<span style=\"font-size:12px; font-family:Dotum; color:#303030; cursor:pointer;\" bgcolor=\"#f3f3f3\">"+calendar_m+"월</span>";
    html += "</td>";
